...
fill = PatternFill(start_color='C4BD97', end_color='C4BD97', fill_type='solid')
...
ws.column_dimensions['A'].width = 22.71 #Setting static column width for A
ws.column_dimensions['B'].width = 105.0 #Setting static column width for B
ws.column_dimensions['C'].width = 7 #Setting static column width for C
